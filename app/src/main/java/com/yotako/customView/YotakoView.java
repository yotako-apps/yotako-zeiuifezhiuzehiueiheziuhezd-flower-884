...
public class YotakoView extends View {
    ...
    public YotakoView(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoView);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoView_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoView_border, 0);
        this.color = ta.getString(R.styleable.YotakoView_shapeColor);
