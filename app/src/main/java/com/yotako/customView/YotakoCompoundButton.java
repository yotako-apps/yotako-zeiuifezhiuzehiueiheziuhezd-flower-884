...
public class YotakoCompoundButton extends CompoundButton {
    ...
    public YotakoCompoundButton(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoCompoundButton);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoCompoundButton_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoCompoundButton_border, 0);
        this.color = ta.getString(R.styleable.YotakoCompoundButton_shapeColor);
        this.originalHeight = ta.getInteger(R.styleable.YotakoCompoundButton_originalHeight, 0);
        this.originalWidth = ta.getInteger(R.styleable.YotakoCompoundButton_originalWidth, 0);
