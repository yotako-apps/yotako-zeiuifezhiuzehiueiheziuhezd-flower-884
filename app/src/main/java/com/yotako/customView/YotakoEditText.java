...
public class YotakoEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public YotakoEditText(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoTextView);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoEditText_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoEditText_border, 0);
        this.color = ta.getString(R.styleable.YotakoEditText_shapeColor);
        this.originalHeight = ta.getInteger(R.styleable.YotakoEditText_originalHeight, 0);
        this.originalWidth = ta.getInteger(R.styleable.YotakoEditText_originalWidth, 0);
