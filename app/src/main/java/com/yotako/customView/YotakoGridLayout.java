...
public class YotakoGridLayout extends GridLayout {
    ...
    public YotakoGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoGridLayout);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoGridLayout_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoGridLayout_border, 0);
        this.color = ta.getString(R.styleable.YotakoGridLayout_shapeColor);
        this.originalHeight = ta.getInteger(R.styleable.YotakoGridLayout_originalHeight, 0);
        this.originalWidth = ta.getInteger(R.styleable.YotakoGridLayout_originalWidth, 0);
