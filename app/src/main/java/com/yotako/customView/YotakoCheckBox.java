...
public class YotakoCheckBox extends android.support.v7.widget.AppCompatCheckBox {
    ...
    public YotakoCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoCheckBox);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoCheckBox_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoCheckBox_border, 0);
        this.color = ta.getString(R.styleable.YotakoCheckBox_shapeColor);
