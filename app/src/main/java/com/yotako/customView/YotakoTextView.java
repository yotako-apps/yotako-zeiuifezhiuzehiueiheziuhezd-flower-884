...
public class YotakoTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public YotakoTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        this.cornerRadius = ta.getFloat(R.styleable.YotakoTextView_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoTextView_border, 0);
        this.color = ta.getString(R.styleable.YotakoTextView_shapeColor);
