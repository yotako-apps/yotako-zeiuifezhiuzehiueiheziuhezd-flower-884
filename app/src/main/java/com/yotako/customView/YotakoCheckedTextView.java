...
public class YotakoCheckedTextView extends android.support.v7.widget.AppCompatCheckedTextView {
    ...
    public YotakoCheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoCheckedTextView);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoCheckedTextView_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoCheckedTextView_border, 0);
        this.color = ta.getString(R.styleable.YotakoCheckedTextView_shapeColor);
        this.originalHeight = ta.getInteger(R.styleable.YotakoCheckedTextView_originalHeight, 0);
        this.originalWidth = ta.getInteger(R.styleable.YotakoCheckedTextView_originalWidth, 0);
