...
public class YotakoStackView extends StackView {
    ...
    public YotakoStackView(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoStackView);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoStackView_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoStackView_border, 0);
        this.color = ta.getString(R.styleable.YotakoStackView_shapeColor);
        this.originalHeight = ta.getInteger(R.styleable.YotakoStackView_originalHeight, 0);
        this.originalWidth = ta.getInteger(R.styleable.YotakoStackView_originalWidth, 0);
