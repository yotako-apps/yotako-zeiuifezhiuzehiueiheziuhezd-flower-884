...
public class YotakoSearchView extends android.support.v7.widget.SearchView {
    ...
    public YotakoSearchView(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoSearchView);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoSearchView_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoSearchView_border, 0);
        this.color = ta.getString(R.styleable.YotakoSearchView_shapeColor);
        this.originalHeight = ta.getInteger(R.styleable.YotakoSearchView_originalHeight, 0);
        this.originalWidth = ta.getInteger(R.styleable.YotakoSearchView_originalWidth, 0);
