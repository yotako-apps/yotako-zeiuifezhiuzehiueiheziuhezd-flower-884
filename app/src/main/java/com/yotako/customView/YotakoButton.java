...
public class YotakoButton extends android.support.v7.widget.AppCompatButton {
    ...
    public YotakoButton(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoButton);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoButton_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoButton_border, 0);
        this.color = ta.getString(R.styleable.YotakoButton_shapeColor);
        this.originalHeight = ta.getInteger(R.styleable.YotakoButton_originalHeight, 0);
        this.originalWidth = ta.getInteger(R.styleable.YotakoButton_originalWidth, 0);
