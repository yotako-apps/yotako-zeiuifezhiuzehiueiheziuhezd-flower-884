...
public class YotakoTableLayout extends TableLayout {
    ...
    public YotakoTableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        this.attrs = attrs;

        TypedArray ta = this.context.obtainStyledAttributes(this.attrs, R.styleable.YotakoTableLayout);

        this.cornerRadius = ta.getFloat(R.styleable.YotakoTableLayout_cornerRadius, 0);
        this.border = ta.getFloat(R.styleable.YotakoTableLayout_border, 0);
        this.color = ta.getString(R.styleable.YotakoTableLayout_shapeColor);
